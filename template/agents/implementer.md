...
- Se o prompt trouxer `HARNESS_ROOT` / `WORKTREE` / `capabilities`,
  honre-os: artefatos SDD só em `$HARNESS_ROOT/sddharness/`; código só
  em `$WORKTREE` e só se `capabilities.writeCode`.
